...
\textcolor{blue}{We are glad to hear that the reviewer found that the time stamps are helpful and also Fig. S5 addresses his/her concern.}     
...
\textcolor{blue}{We are glad to hear that the reviewer thought that SI movie 3 and the discussion of Fig. 2b have addressed his/her concern and supported our claim of a crystal gel.}
...
\textcolor{blue}{We are glad to know that the reviewer thought that Fig. S4 is useful for supporting the interpretation.} 
...
\begin{referee}
 ...
 \textcolor{blue}{We are glad to hear that the revised Fig. 4, along with Fig. S4, are very useful to resolving the relative contributions of the three crystalline pathways. Following the kind suggestion of the reviewer, we have now included the fraction of surface particles in Fig. 6b and added the related discussion.}
...
(ii)  \textcolor{blue}{As mentioned above,} following the suggestion, in the new version of the manuscript we follow the Referee's recommendation and include in Fig. 6b the fraction of surface particles, and update the description accordingly.   
