...
crystalline nuclei have outgrown the liquid regions in which they form. \textcolor{blue}{Process (2) has been completely overlooked so far, although it plays a crucial role 
in not only in the kinetic pathway but also the morphology, as we discussed above. We note that this is the crucial step  
...
\textcolor{blue}{Many monoatomic and single-component molecular systems can satisfy all these conditions in a certain range of the temperature and pressure. 
