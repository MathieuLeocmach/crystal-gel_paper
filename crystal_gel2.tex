...
A typical phase ordering process observed at $\phi\approx 0.33$ and $c_p=0.38$ mg/g can be seen in Supplementary Movies 1 and 2 (two-dimensional (2D)) 
and 3 (three-dimensional (3D)). 
