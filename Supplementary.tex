...
are analysed in order to determine whether a colloidal particles is in the
...
shown in Fig.~\ref{fig:capillary}, where a system with colloid volume fraction of $\approx 0.33$ and polymer concentration is $0.40\,$mg/g is considered.
The figure shows the time evolution of the sample at three different times, just after phase separation ($t=340\,\tau_\beta$), and during
crystal-gel formation ($t=2600\,\tau_\beta$ and $t=6650\,\tau_\beta$). The top-row shows images from quasi two-dimensional confocal slices, while the bottom-row shows
the three-dimensional reconstruction after single-particle tracking, where crystalline particles are highlighted in both size and color (red).
