...
With a new confocal microscopy protocol, \textcolor{blue}{we follow the entire kinetics of phase separation, from the homogeneous phase, percolation, stress driven ageing, and until the formation of the final structure.
...
We clarify the physical requirements necessary for this to happen and show that crystallization leads to a network structure different from the original phase separation pattern.} 
