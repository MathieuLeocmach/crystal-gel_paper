...
With a new confocal microscopy protocol, \textcolor{blue}{we successfully follow the entire kinetics of phase separation at a single-particle level, from the homogeneous phase, percolation, stress driven ageing, and until the formation of the final gel structure.
This allows us to unveil a novel crystallization pathway to sponge-like porous crystal structures in a colloid-polymer mixture undergoing viscoelastic gas-liquid phase separation and to reveal its physical mechanism.}
%\textcolor{blue}{We follow the entire kinetics of phase separation, from the homogeneous phase, percolation, stress driven aging, and until the formation of porous crystals.}
We show that crystallization leads to a network structure different from the original phase separation pattern. 
Crystals nucleate inside the liquid network, but grow past it by direct condensation of the gas phase on their surface, i.e. de-sublimation, driving evaporation of nearby liquid. 
