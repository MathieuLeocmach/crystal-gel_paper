...
the random gelation universality class exponent ($D=2.53$) as shown by the gray line in the inset of Fig.~\ref{fig:network_formation}. Here we do not imply that the formation of the network follows the random gelation universality class, but just that our
